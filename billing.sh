...
# Composer ইনস্টল না থাকলে স্বয়ংক্রিয়ভাবে ইনস্টল করে নেওয়া
...
wget -O ext.zip https://github.com/sdgamer8263-sketch/pterodactyl_extention1/archive/refs/heads/main.zip
unzip -o ext.zip
cd pterodactyl_extention1-main

cp -r PanelFiles/app/* /var/www/pterodactyl/app/ 2>/dev/null
cp -r PanelFiles/resources/* /var/www/pterodactyl/resources/ 2>/dev/null
cp -r PanelFiles/database/* /var/www/pterodactyl/database/ 2>/dev/null
cp -r PanelFiles/routes/* /var/www/pterodactyl/routes/ 2>/dev/null

cd /var/www/pterodactyl
rm -rf ext.zip pterodactyl_extention1-main

export COMPOSER_ALLOW_SUPERUSER=1
composer require stripe/stripe-php --no-interaction --ignore-platform-reqs
composer require paypal/rest-api-sdk-php:* --no-interaction --ignore-platform-reqs
composer require laraveldaily/laravel-invoices:^3.3.1 --no-interaction --ignore-platform-reqs
...
apt-get update -y
apt-get install -y php8.3-intl || apt-get install -y php-intl
...
# Admin Layout & Routes configuration as requested
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="{{ ! starts_with(Route::currentRouteName(), 'admin.settings') ?: 'active' }}"><a href="{{ route('admin.settings')}}"><i data-lucide="settings"></i> <span>Settings</span></a></li>
                <li class="arix"><a href="/admin/arix"><i data-lucide="wand-2"></i><span>CLOUDVEX Theme</span></a></li>
                <li class="{{ ! starts_with(Route::currentRouteName(), 'admin.api') ?: 'active' }}"><a href="{{ route('admin.api.index')}}"><i data-lucide="webhook"></i> <span>Application API</span></a></li>
                ...
                <li class="{{ ! starts_with(Route::currentRouteName(), 'admin.databases') ?: 'active' }}"><a href="{{ route('admin.databases') }}"><i data-lucide="database"></i> <span>Databases</span></a></li>
                <li class="{{ ! starts_with(Route::currentRouteName(), 'admin.locations') ?: 'active' }}"><a href="{{ route('admin.locations') }}"><i data-lucide="globe-2"></i> <span>Locations</span></a></li>
                <li class="{{ ! starts_with(Route::currentRouteName(), 'admin.nodes') ?: 'active' }}"><a href="{{ route('admin.nodes') }}"><i data-lucide="server"></i> <span>Nodes</span></a></li>
                <li class="{{ ! starts_with(Route::currentRouteName(), 'admin.servers') ?: 'active' }}"><a href="{{ route('admin.servers') }}"><i data-lucide="terminal-square"></i> <span>Servers</span></a></li>
                <li class="{{ ! starts_with(Route::currentRouteName(), 'admin.users') ?: 'active' }}"><a href="{{ route('admin.users') }}"><i data-lucide="users"></i> <span>Users</span></a></li>
                
                <li class="header">SERVICE MANAGEMENT</li>
                <li class="{{ ! starts_with(Route::currentRouteName(), 'admin.mounts') ?: 'active' }}"><a href="{{ route('admin.mounts') }}"><i data-lucide="folder"></i> <span>Mounts</span></a></li>
                <li class="{{ ! starts_with(Route::currentRouteName(), 'admin.nests') ?: 'active' }}"><a href="{{ route('admin.nests') }}"><i data-lucide="layout-grid"></i> <span>Nests</span></a></li>
            </ul>
        </section>
    </aside>
...
# Shop & Billing Routes যোগ করা হচ্ছে
