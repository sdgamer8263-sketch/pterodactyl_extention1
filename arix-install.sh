...
# Yeh command unzip karke purani files ko overwrite kar degi (-o ka matlab overwrite hai)
...
# --yes lagaya hai taaki agar pehle se key ho toh bina ruke overwrite kar de
